...
dx = x(2)-x(1);
%POTENTIAL:
for a = 0.5                       % Saxon-Woods Potential parameter
...
Pa = 0.0873 ;                               % Pre-formation probability : For Po (Table I) : http://hal.in2p3.fr/in2p3-00637971/document                   
gamma = f.* P;                 % decay constant (multiply by Pa to see the effect of the preformation probability)
half_life = log(2)./ gamma;    % half-life
log_half_life = log(half_life);
Rti= (1.42321736e17 )./(half_life);  % ex half life/ num half life
Rt=1./Rti;
% OUTPUTS ===================================
T=table(l,U0,E,A,Z,R0,R1,vA,f,P,gamma,half_life,log_half_life,Rt)
end
end
%======================== GRAPHICS ========================================
